...
## [0.4.1](https://github.com/suiflex/ForgeGuard/compare/v0.4.0...v0.4.1) (2026-09-09)

### Features

* **tray:** implement desktop system tray ([bbb](https://github.com/suiflex/ForgeGuard/commit/bbb))
* **cli:** enhance server commands ([aaa](https://github.com/suiflex/ForgeGuard/commit/aaa))
* **core:** add missing feature from external ([ccc](https://github.com/suiflex/ForgeGuard/commit/ccc))

### Bug Fixes

* **broker:** resolve race in background job ([ddd](https://github.com/suiflex/ForgeGuard/commit/ddd))

## [0.4.0](https://github.com/suiflex/ForgeGuard/compare/v0.3.0...v0.4.0) (2026-09-04)

### Features

* **init:** initial release ([eee](https://github.com/suiflex/ForgeGuard/commit/eee))
"""
...
* **cli:** maintainer only ([aaa](https://github.com/suiflex/ForgeGuard/commit/aaa))
"""
